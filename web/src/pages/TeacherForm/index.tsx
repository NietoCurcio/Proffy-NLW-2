...
const TeacherForm = () => {
  // usar estado porque o react nao fica observando as variaveis comuns
  // quando incrementamos esse 'estado', por isso usar o state
  // e nao um array const Items =[{},{}...]
  ...
  const setScheduleItemValue = (position: number, field:string, value:string) => {
    const updatedSchduleItems = scheduleItems.map((item, index)  => {
      if(index === position) {
